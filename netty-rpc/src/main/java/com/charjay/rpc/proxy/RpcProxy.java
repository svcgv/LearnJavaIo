...
import com.charjay.rpc.core.InvokerMsg;
...
class MethodProxy implements InvocationHandler{
	...
	public Object rpcInvoke(Method method,Object[] args){
		...
		try{
			...
			ChannelFuture f = b.connect(CustomConfig.getString("rpc.remote.ip"),CustomConfig.getInt("rpc.remote.port")).sync();
